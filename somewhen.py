...
class Somedate(datetime.date):
    ...
    def __new__(cls, *args, **kwargs):
        if not cls._singleton:
            cls._singleton = datetime.date.__new__(cls, year=2000, month=1, day=1)
        return cls._singleton
...
class Sometime(datetime.time):
    ...
    def __new__(cls, *args, **kwargs):
        if not cls._singleton:
            cls._singleton = datetime.time.__new__(cls)
        return cls._singleton
